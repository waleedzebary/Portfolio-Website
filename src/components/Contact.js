                    ...
                    <Col md={6}>
                        ...
                        <form onSubmit={handleSubmit}>
                            <Row>
                                ...
                                <Col sm={6} className="px-1">
                                    <input type="tel" value={formDetails.phone} placeholder="Phone No." onChange={(event) => onFormUpdate('phone', event.target.value)}/>
                                </Col>
                                <Col>
                                    <textarea rows={8} value={formDetails.message} placeholder="Message" onChange={(event) => onFormUpdate('message', event.target.value)}/>
